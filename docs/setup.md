...
4. To shut down the server in foreground press CTRL-C or if running in the background the JBOSS cli can be used to connect to the instance and shut it down.
